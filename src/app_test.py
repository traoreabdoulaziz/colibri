...
def test_upload_taxpayer_info():
    response=client.post("/api/upload_taxpayer_info/?id=azi&type=photo_id", 
                         files={"file": ("file.jpg", open("az.jpg", "rb"), "image/jpg")}
                        ,headers={"Authorization": "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpZCI6IjNzNlkzbzdRUk93UmtiMXplM2l6IiwidXNlcm5hbWUiOiJheml6IiwicGFzc3dvcmRfaGFzaCI6IiQyYiQxMiRsVGI2S3RGZk9MQlJPTlZCb2tRYlNlemdXUGZ4WUxnTkFLc3BRSnlPb2cwNXRwYUtZdlFyZSJ9.mFNVcLMeFhuleJI3g4CwVuxpqrhqYEOW44TlEM2NkjY"})
    assert response.status_code == 200
  
## test download activity
def test_upload_activity_info():
    response=client.post("/api/upload_activity_info/?id=az&type=photo_activity",
                        files={"file": ("file.jpg", open("az.jpg", "rb"), "image/jpg")},
                        headers={"Authorization": "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpZCI6IjNzNlkzbzdRUk93UmtiMXplM2l6IiwidXNlcm5hbWUiOiJheml6IiwicGFzc3dvcmRfaGFzaCI6IiQyYiQxMiRsVGI2S3RGZk9MQlJPTlZCb2tRYlNlemdXUGZ4WUxnTkFLc3BRSnlPb2cwNXRwYUtZdlFyZSJ9.mFNVcLMeFhuleJI3g4CwVuxpqrhqYEOW44TlEM2NkjY"})
    assert response.status_code == 200
...
def test_download_activity_info():
    response=client.get("/api/download_activity_info/?id=az&type=photo_activity",
                        headers={"Authorization": "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpZCI6IjNzNlkzbzdRUk93UmtiMXplM2l6IiwidXNlcm5hbWUiOiJheml6IiwicGFzc3dvcmRfaGFzaCI6IiQyYiQxMiRsVGI2S3RGZk9MQlJPTlZCb2tRYlNlemdXUGZ4WUxnTkFLc3BRSnlPb2cwNXRwYUtZdlFyZSJ9.mFNVcLMeFhuleJI3g4CwVuxpqrhqYEOW44TlEM2NkjY"})
    assert response.status_code == 200
    
## test download taxpayer
def test_download_taxpayer_info():
    response=client.get("/api/download_taxpayer_info/?id=az&type=photo_id",
                        headers={"Authorization": "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpZCI6IjNzNlkzbzdRUk93UmtiMXplM2l6IiwidXNlcm5hbWUiOiJheml6IiwicGFzc3dvcmRfaGFzaCI6IiQyYiQxMiRsVGI2S3RGZk9MQlJPTlZCb2tRYlNlemdXUGZ4WUxnTkFLc3BRSnlPb2cwNXRwYUtZdlFyZSJ9.mFNVcLMeFhuleJI3g4CwVuxpqrhqYEOW44TlEM2NkjY"})
    assert response.status_code == 200
